/*
	mediaboxAdvanced v0.9.9d - The ultimate extension of Mediabox into an all-media script
	updated 2009.03.28
	...
	*/
	...
	Mediabox = {
		...
		open: function(_images, startImage, _options) {
			options = $extend({
				loop: false,					// Permite navegar entre las imágenes primera y última
				stopKey: true,					// Impide la acción de teclado por defecto (como flechas arriba / abajo), en lugar de los accesos directos
													// No se aplica a iFrame de contenido
													// No afecta el desplazamiento del ratón
				overlayOpacity: 0.7,			// 1 es opaco, 0 es completamente transparente (cambiar el color en el archivo CSS)
													// Recuerde que Firefox 2 y Camino 1.6 en Mac requieren un segundo plano. Png establecidos en la CSS
				resizeDuration: 240,			// Duración de cada uno de los cuadro de tamaño de las animaciones (en milisegundos)
				resizeTransition: false,		// Transición por defecto en mootools
				initialWidth: 360,				// Anchura inicial de la caja (en píxeles)
				initialHeight: 240,				// Altura inicial de la caja (en píxeles)
				showCaption: true,				// Mostrar el título y el subtítulo, verdadero / falso
				animateCaption: true,			// Animar la leyenda, verdadero / falso
				showCounter: true,				// Si es cierto, un contador sólo se muestra si hay más de 1 imagen para mostrar
				counterText: '  ({x} of {y})',	// Traducir o cambiar a su gusto
//			Global media options
				scriptaccess: 'true',		// Permitir el acceso a la secuencia de comandos de archivos flash
				fullscreen: 'true',			// Use fullscreen (Utilización completa)
				fullscreenNum: '1',			// 1 = true (verdadero)
				autoplay: 'true',			// Reproduce el vídeo tan pronto como se abrió
				autoplayNum: '1',			// 1 = verdadero
				autoplayYes: 'yes',			// yes = verdadero
				bgcolor: '#eee',			// Color de fondo, utilizado para los medios flash y QT
//			JW Media Player settings and options
				playerpath: 'quiltro02/player-viral.swf',	// Camino al mediaplayer.swf o flvplayer.swf archivo
				backcolor:  '000000',		// El color base de la controladora, el color, nombre, valor hexadecimal (0x000000)
				frontcolor: '999999',		// Texto y el botón de color para el controlador, el color, nombre, valor hexadecimal (0x000000)
				lightcolor: '000000',		// Rollover de color para el controlador, el color, nombre, valor hexadecimal (0x000000)
				screencolor: '000000',		// Rollover de color para el controlador, el color, nombre, valor hexadecimal (0x000000)
				controlbar: 'over',			// abajo, más, ninguno (este valor se ignora cuando se reproducen archivos de audio)
//			NonverBlaster
				useNB: true,				// NonverBlaster uso en lugar de la JW Media Player. flv y. mp4
				NBpath: 'quiltro02/NonverBlaster.swf',	// Camino al NonverBlaster.swf
				NBloop: 'true',				// Bucle de reproducción de vídeo, verdadero / falso
				controllerColor: '0x777777',	// fijar el color controlbar
				showTimecode: 'false',		// a su vez fuera de tiempo o en la pantalla
//			Quicktime options
...
if ((Browser.Engine.gecko) && (Browser.Engine.version<19)) {
	...
	Element.implement({
		mediabox: function(_options, linkMapper) {
			$$(this).mediabox(_options, linkMapper);	//El tratamiento de un solo elemento es similar a la transformación de una colección con un único elemento
	...
	Elements.implement({
		/*
opciones: opciones de Facultativo objeto, ver Mediabox.open () 
linkMapper: Opcional función teniendo un vínculo elemento DOM y un índice como argumentos y devolver una matriz que contiene 3 elementos: 
URL de la imagen y la imagen de título (puede contener HTML) 
linksFilter: Opcional función teniendo un vínculo elemento DOM y un índice como argumentos y devolver true si el elemento es parte de 
la colección de imágenes que se muestra al hacer clic, si no falsa. "esto" se refiere al elemento que se ha hecho clic. 
Esta función debe retornar true si el elemento DOM argumento es"this".
		*/
